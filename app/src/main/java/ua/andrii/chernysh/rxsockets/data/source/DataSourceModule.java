...
import ua.andrii.chernysh.rxsockets.data.network.source.LightsSocketDataSource;
...
public interface DataSourceModule {
    ...
    @Binds
    @ApplicationScope
    LightsDataSource provideLightsDataSource(LightsSocketDataSource dataSource);
}
